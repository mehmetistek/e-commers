...
export function addToCart(event, products){
    ...
    //*products dizisi içerisinden idsine ulaştuğımız ürünü bulabilmek için find metodunu kullandık
...
cart.push(cartItem); //* cart dizisine yeni oluştuduğumuz objeyi gönderdik.
...
//* Sepetteki her bir ürün için ekrana bir tane cart-item bileşeni aktardık.
  ...
  //* herbir buton için olay izleyicisi ekle vebir fonksiyon çalıştır.
